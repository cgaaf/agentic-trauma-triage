...
export async function mockEvaluate(): Promise<{
  ...
  return {
    ...
    hybridConfirmations: [],
    reasoning:
      "[MOCK MODE] LLM evaluation was not performed. In production, Claude Sonnet would analyze mechanism of injury, anatomical injuries, and other qualitative criteria here.",
  };
}
