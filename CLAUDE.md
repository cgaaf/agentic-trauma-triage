...
- **Transcription route**: `src/routes/api/transcribe/+server.ts` — audio-to-text via OpenAI gpt-4o-transcribe
- **Audio recorder**: `src/lib/audio/recorder.svelte.ts` — push-to-talk state machine with silence detection
