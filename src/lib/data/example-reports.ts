...
export const exampleReports: ExampleReport[] = [
  {
    label: "Level 1 MVC",
    description: "High-speed MVC with complete vitals — expect full Level 1 trauma activation",
...
IV access x2 established, 500mL NS bolus initiated. C-collar applied, boarded. ETA 8 minutes.`,
  },
  {
    ...
    description: "Geriatric fall with missing RR, GCS, and breathing — shows missing data warnings",
...
IV access established. C-collar applied. ETA 10 minutes.`,
  },
  {
    ...
    description: "Minor fall with normal vitals — expect no trauma activation",
